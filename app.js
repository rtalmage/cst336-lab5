...
function getRandomImage(keyword, count) {
    return new Promise (function(resolve, reject) {
        let requestUrl = `https://api.unsplash.com/photos/random/?count=${count}&client_id=mC_TrwvfMp1LNkfWmw4iPmy_K68TEC-w6DaTD4O_PK0&featured=true&orientation=landscape&query=${keyword}`
